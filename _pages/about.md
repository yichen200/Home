...
<div class="paper-item">
  ...
  <div class="pap">
    ...
    <div id="abstract-raindrop" style="display: none; margin-top: 10px; font-family: Arial, sans-serif; font-size: 14px; font-weight: normal; border-left: 4px solid #165740; padding-left: 10px;">
      Raindrops on camera lenses can cause occlusions and distortions that significantly impact the performance of computer vision models in autonomous vehicles. This study evaluates the effects of raindrop patterns and densities on object detection algorithms, proposing solutions to mitigate their impact and improve robustness in adverse weather conditions.
    </div>
  </div>
</div>
